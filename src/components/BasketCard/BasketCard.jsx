  ...
  <article className="basket-card">
    ...
    <div className="basket-card__body">
      <div className="basket-card__heading">
        ...
        <button className="basket-card__remove-button"
      ...
      <div className="basket-card__price">
        <div className="basket-card__price-summary">Price: {price.toFixed(2)} &#8381; x {amount}</div>
        <div className="basket-card__price-info">
          <Counter className="basket-card__counter" value={amount}
